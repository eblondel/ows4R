...
modelling an PropertyIsLesserThanOrEqualTo
...
- [`PropertyIsLessThanOrEqualTo$new()`](#method-PropertyIsLessThanOrEqualTo-new)

- [`PropertyIsLessThanOrEqualTo$clone()`](#method-PropertyIsLessThanOrEqualTo-clone)
