...
modelling a WCS DescribeCoverage request
...
- [`WCSDescribeCoverage$new()`](#method-WCSDescribeCoverage-new)

- [`WCSDescribeCoverage$clone()`](#method-WCSDescribeCoverage-clone)
