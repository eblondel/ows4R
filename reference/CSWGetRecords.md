...
modelling a CSW GetRecords request
...
- [`CSWGetRecords$new()`](#method-CSWGetRecords-new)

- [`CSWGetRecords$clone()`](#method-CSWGetRecords-clone)
...
- `...`:
  ...
  any parameter to pass to the service request, such as `resultType`,
  `startPosition`, `maxRecords`, `outputFormat`, or `outputSchema`
