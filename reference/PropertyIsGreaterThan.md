...
modelling an PropertyIsGreaterThan
...
- [`PropertyIsGreaterThan$new()`](#method-PropertyIsGreaterThan-new)

- [`PropertyIsGreaterThan$clone()`](#method-PropertyIsGreaterThan-clone)
