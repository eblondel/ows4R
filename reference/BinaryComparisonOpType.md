...
modelling an BinaryComparisonOpType
...
- [`BinaryComparisonOpType$new()`](#method-BinaryComparisonOpType-new)

- [`BinaryComparisonOpType$clone()`](#method-BinaryComparisonOpType-clone)
