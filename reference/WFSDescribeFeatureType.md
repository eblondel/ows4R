...
modelling a WFS DescribeFeatureType request

## Note

Abstract class used by ows4R to trigger a WFS DescribeFeatureType
request
...
- [`WFSDescribeFeatureType$new()`](#method-WFSDescribeFeatureType-new)

- [`WFSDescribeFeatureType$clone()`](#method-WFSDescribeFeatureType-clone)
