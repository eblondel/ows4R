...
We thank in advance people that use ``ows4R`` for citing it in their work / publication(s). For this, please use the citation provided at this link [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.1345111.svg)](https://doi.org/10.5281/zenodo.1345111) [![Join the chat at https://gitter.im/ows4R/CSW](https://badges.gitter.im/ows4R/CSW.svg)](https://gitter.im/ows4R/CSW?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
